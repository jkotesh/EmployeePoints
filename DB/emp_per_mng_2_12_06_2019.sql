...
-- Dumping data for table emp_per_mng.admin_users: ~2 rows (approximately)
/*!40000 ALTER TABLE `admin_users` DISABLE KEYS */;
INSERT INTO `admin_users` (`id`, `name`, `email`, `password`, `mobileno`, `reset_hash`, `profile_image`, `total_points`, `role_id`, `status`, `created_by`, `created_on`, `modified_on`, `modified_by`) VALUES
	(1, 'Admin', 'admin@gmail.com', '$2y$10$nTF88GGn.E24knOZsqwJnODsusjh2dhR1A7rngEBAXN/lcUZicGWG', '8008615717', '19fb225df9fa196104497eadcb7d9269e32b148c6fe127b44aafd5f6334fb3b3', NULL, 0, 1, 1, 1, '0000-00-00 00:00:00', '2019-05-10 15:15:24', 1),
	(9, 'Raviteja', 'ch.raviteja2@gmail.com', '$2y$10$YK..3m4iE4qIuvA/TO2sX.V2TxmCQ1LwdgYoFTYxBtV7Bxt5KwGWi', '7989698655', '67f7bfa7c48ba15c27a47edefab738ca79309aaa02a34a1933366111fab431dd', 'http://empmanagement/assets/images/users/9.jpg', 1, 2, 1, 1, '2019-06-12 11:28:08', '2019-06-12 13:12:43', 1);
...
-- Dumping data for table emp_per_mng.employee_points_daily: ~1 rows (approximately)
...
INSERT INTO `employee_points_daily` (`id`, `employee_id`, `points`, `date`, `comments`, `created_at`, `updated_at`) VALUES
	(1, 9, 1, '2019-06-12', 'test', '2019-06-12 18:35:44', '2019-06-12 18:35:44');
...
-- Dumping data for table emp_per_mng.log: ~1 rows (approximately)
/*!40000 ALTER TABLE `log` DISABLE KEYS */;
INSERT INTO `log` (`id`, `module_id`, `created_on`, `user_id`, `action`, `category`, `description`, `log_type`) VALUES
	(1, 2, '2019-06-12 18:35:44', 1, 'create', 1, 'Ravitejagot 1 on 2019-06-12', 1);
